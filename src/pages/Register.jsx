    ...
    <div className="min-h-[calc(100vh-57px)] flex items-center justify-center">
      <div className="w-full max-w-md bg-white feature-card p-8 rounded-xl shadow-sm border border-gray-200">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2 faq-answer">Get started with your free account</p>
        </div>
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          <div>
            <label
              htmlFor="name"
              className="faq-answer block text-sm font-medium text-gray-700 mb-1"
            >
              Full Name
            </label>
            <input
          ...
          <div className="flex items-center mt-4">
            ...
            <label
              htmlFor="terms"
              className="ml-2 block text-sm text-gray-700 faq-answer"
            >
              I agree to the <Link to="/terms-of-service"
        ...
        <div className="relative my-6">
          <div className="absolute inset-0 flex items-center">
            <div className="w-full border-t border-gray-300 singin-divider"></div>
          </div>
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white feature-card text-gray-500">Or sign up with</span>
          </div>
        </div>
        ...
        <div className="mt-6 text-center text-sm">
          <p className="text-gray-500 faq-answer">
            ...
            <Link
              to="/login"
              className="font-medium ml-1 text-indigo-400 hover:underline"
            >
              Sign in
            </Link>
          </p>
