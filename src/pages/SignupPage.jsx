    ...
    const handleSignUp = async (e) => {
        ...
        createUser(email, password)
            .then(async result => {
                ...
                setUser({ ...updatedFirebaseUser, displayName: name });
        ...
        <div className="flex flex-col items-center justify-center px-4 py-12">
            ...
            <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-sm border border-gray-200">
                ...
                <form onSubmit={handleSignUp} className="space-y-4">
                    ...
                    <button
                        type="submit"
                        className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-cyan-700 hover:bg-cyan-800 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-800 transition duration-150" disabled={loading}
                    >
                        {loading ? (
                            <>
