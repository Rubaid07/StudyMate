...
const DemoPreview = () => {
  ...
  return (
    <section id="demo-preview" className="py-16 lg:py-24 bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-12">
          <div className="bg-gray-800 rounded-2xl p-2 flex space-x-2">
            {[
        ...
        <div className="relative bg-gray-800 rounded-3xl p-8 shadow-2xl">
          ...
          <div className={`mx-auto transition-all duration-500 ${
            ...
            {/* Device Mockup */}
            <div className={`relative rounded-3xl border-8 border-gray-700 bg-gray-900 shadow-2xl ${
          ...
          <div className="flex items-center justify-center mt-8 space-x-6">
            <button
              onClick={prevSlide}
              className="p-3 bg-gray-700 rounded-full hover:bg-gray-600 transition-colors duration-300 group"
            >
            ...
            <button
              ...
              className="p-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-110"
            >
              {isPlaying ? (
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          {[
            ...
            <div key={index} className="text-center p-6 bg-gray-800 rounded-2xl hover:bg-gray-700 transition-colors duration-300">
